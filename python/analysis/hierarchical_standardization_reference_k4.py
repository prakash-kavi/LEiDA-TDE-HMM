...
standardization approaches (global, bygroup) using k=4 models.
...
REFERENCE_DIR = os.path.join(RESULTS_DIR, 'standardization_reference', 'k4')
...
def visualize_state_activation_patterns(bygroup_correspondences, all_metrics, networks_list=NETWORK_CONFIGS):
    ...
    for networks in networks_list:
        ...
        fig, axes = plt.subplots(n_correspondences, 1, figsize=(10, 4*n_correspondences))
